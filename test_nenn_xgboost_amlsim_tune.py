...
#
# test_nenn_xgboost_amlsim_tune.py: NENN + XGBoost hyperparametrization
#
    ...
    for it in range(5):
        ...
        with torch.no_grad():
            ...
            for data in validation_data:
                ...
                val_steps += 1
                embeddings_val += embedding_test.numpy().tolist()
        ...
        y_pred = xgb_model.predict(embeddings_val)


        f1_0 = f1_score(
            y_true, y_pred, average='binary', labels=[0]
        )
...
def main():
    ...
    if not checkpoint_params['executions_results']['precs_macro']:
        ...
        best_eta = best_result.config['eta']
        best_max_depth = best_result.config['max_depth']
        ...
        checkpoint_params['best_eta'] = best_eta
        checkpoint_params['best_max_depth'] = best_max_depth
        checkpoint_saver()
    else:
        ...
        best_eta = checkpoint_params['best_eta']
        best_max_depth = checkpoint_params['best_max_depth']
    ...
    results_passed = len(checkpoint_params['executions_results']['precs_macro'])
    ...
    for i in range(n_repeats):
        ...
        prec_macro, rec_macro, f1_macro, prec_0, rec_0, f1_0 = train_test_best(
            best_node_emb_size,
            best_edge_emb_size,
            best_weight,
            best_lr,
